...
candidate-bound red/green evidence. Do not use any other logs or workspace
files. Judge whether each red failure actually represents the behavior stated
in that item's `before` value before citing its proof ID.
