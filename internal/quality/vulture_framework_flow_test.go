...
func TestPythonVultureFrameworkAncestryAndDecoratorIdentity(t *testing.T) {
	...
	assertFrameworkDiagnostics(t, sources, []string{"readable", "readinto", "buffer", "do_CUSTOM", "log_message", "message", "args", "consistent_state", "transition", "initial_state"}, []string{"unused_hook"})
