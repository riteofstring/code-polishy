...
func TestProviderFindingsAndGraphSurviveManagedReports(t *testing.T) {
	...
	input := sourcegraph.FactInput{Analyzer: "pack", Protocol: "code-polishy-pack/v4", Project: "pack/custom-provider/analyze", Root: ".", Paths: []string{node.Path}, FactsSHA256: digest, PartitionsSHA256: digest, ResolutionSHA256: digest,
