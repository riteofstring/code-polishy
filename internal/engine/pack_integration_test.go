...
func TestOpenResolvesExactCommunityPackAndDoctorUsesItsCoverage(t *testing.T) {
	...
	config := fmt.Sprintf(`{"version":5,"project":{"kind":"content"},"packs":[{"name":%q,"version":%q,"digest":%q}],"modules":[{"name":"app","paths":["src/**"]}],"tests":{"ownership":[],"suites":[{"name":"app-test","kind":"unit","scope":"module","modules":["app"],"argv":["go","test","./..."]},{"name":"full","kind":"contract","scope":"repository","argv":["go","test","./..."]}]}}`, identity.Name, identity.Version, identity.Digest)
