...
func TestProviderGraphBindsNewLanguagesAndPreservesCrossLanguageCycles(t *testing.T) {
	...
	input := FactInput{Analyzer: "pack", Protocol: "code-polishy-pack/v2", Project: "pack/custom/analyze", Root: ".", Paths: []string{nodes[0].Path}, FactsSHA256: digest, PartitionsSHA256: digest, ResolutionSHA256: digest, Provider: &ProviderInput{Name: "custom", Version: "1.0.0", Digest: digest, Languages: []string{"custom"}, InputsSHA256: digest, PolicySHA256: digest, RuntimeSHA256: digest}}
