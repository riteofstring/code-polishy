...
func TestSummarySeparatesProductionTestsAndDeclaredConcentration(t *testing.T) {
	...
	config := policy.Config{
		...
		Tests: policy.Testing{Ownership: []policy.TestOwnership{{Paths: []string{"api/api_test.go"}, Module: "api", FocusedSuite: "api-unit"}}, Suites: []policy.TestSuite{{
	...
	summaries := Summary(repo, []string{"api/api.go", "api/api_test.go", "domain/model.go", "README.md"}, nil)
