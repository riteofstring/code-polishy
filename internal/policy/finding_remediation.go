...
var findingRemediationRules = []struct {
	...
	{"policy.sourceContextOwnership", "Map each generated source to its actual contained ecosystem context and remove missing, stale, cyclic, or overlapping declarations."},
	...
	{"policy.pythonContract", "Correct the exact runtime contract or remove a stale declaration; verify its target, consumed members, and owning Python project."},
