...
func TestRuntimeSchemaRejectsStructureAcceptedByTypedDecoding(t *testing.T) {
	t.Parallel()
	configuration := strings.Replace(minimalConfig(), `{"version":3`, `{"$schema":"","version":3`, 1)
...
func TestRuntimeSchemaOwnsConditionalBoundaries(t *testing.T) {
	...
	cases := map[string]string{
		...
		"behavior review scope":        strings.Replace(minimalConfig(), `"checks":[]`, `"verification":{"behaviorReview":{"features":[{"name":"content","suites":["content-test"]}]}},"checks":[]`, 1),
...
func TestRuntimeSchemaClosesEveryObjectBoundary(t *testing.T) {
  ...
  "scope":{
    ...
    "pythonDynamicReferences":[{"project":"pyproject.toml","module":"app.entry","symbol":"serve"}],
    ...
    "pythonExternalAttributes":[{"project":"pyproject.toml","module":"app","callable":"load","receiver":"settings","attribute":"path","line":1,"consumerType":"external.Settings"}],
  ...
  "verification":{"behaviorReview":{"features":[{"name":"content","modules":["content"],"suites":["content-test"]}]},"mergeGate":{"recommendedModules":["content"]}},
  ...
  "tests":{"suites":[{"name":"content-test","kind":"content","scope":"module","modules":["content"],"argv":["test"],"artifacts":[{"path":"junit.xml","type":"junit"}]},{"name":"full","kind":"content","scope":"repository","argv":["test"]}]},
  "supplyChain":{
  ...
  "exceptions":[{"id":"temporary","check":"quality.lines","path":"content/file.go","subject":"file","reason":"migration","owner":"content","expires":"2026-09-30"}]
	...
	boundaries := map[string][]any{
		...
		"dynamic reference": {"scope", "pythonDynamicReferences", 0}, "computed import": {"scope", "pythonComputedImports", 0},
