...
satisfy the contract. Configured attributes now retain exact class assignments
on proven types and instance writes reached through proven constructors,
...
check deferral without a language-specific core branch. Remaining contract and
reachability interpretation is required before the pack can claim complete
dead-code parity.
