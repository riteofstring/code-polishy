...
| Distribution and migration  | Only local source install, verify, and root exist; there is no authenticated catalog, list, update, remove, or migration preview.         | Pack lifecycle and upgrade transaction              | Local fixture catalog, atomic failure, preview, rollback, and installed-release cases                            | Open.                                                                                     |
