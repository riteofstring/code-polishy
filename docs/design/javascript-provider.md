...
configs are not merged or guessed. Projects are keyed by core-resolved analysis
unit identity, so nested packages sharing an inherited configuration retain their
